...
public class ConnectEx2 : MonoBehaviour
{
    public Text Ex2Name;
    public Text Ex2Price;
    string id;
    ...
    private void Start()
    {
        ...
        try
        {
            conn2.Open();
            Debug.Log("以建立連結測試");
            string sql2 = "select * from goods where gNo='20'";
            ...
            if (rdr2.Read())
            {
                ...
                Ex2Name.text = rdr2.GetString("gName");
                Ex2Price.text = rdr2.GetString("price")+("元");

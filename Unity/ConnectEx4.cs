...
public class ConnectEx4 : MonoBehaviour
{
    public Text Ex4Name;
    public Text Ex4Price;
    string id;
    ...
    private void Start()
    {
        ...
        try
        {
            conn2.Open();
            Debug.Log("以建立連結測試");
            string sql2 = "select * from goods where gNo='24'";
            ...
            if (rdr2.Read())
            {
                ...
                Ex4Name.text = rdr2.GetString("gName");
                Ex4Price.text = rdr2.GetString("price") + ("元");
